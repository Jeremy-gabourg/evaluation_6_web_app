...
<body class="bg-dark text-success">
    ...
    <header class="container-fluid d-flex pt-3">
        ...
        <span class="p-1 fw-bold align-self-end">
            <a role="button" class="text-reset d-none d-md-inline-flex" href="/controleurs/connexion_page.php">
                Connexion
            </a>
            <a role="button" class="text-reset text-success d-inline-flex d-md-none" href="/assets/php/connexion_page.php">
