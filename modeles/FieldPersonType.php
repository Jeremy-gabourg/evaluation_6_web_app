...
class FieldPersonType
{
            ...
            if ($statement2->execute()) {
                while($types = $statement2->fetchObject('FieldPersonType')){
                    echo     '<tr class="align-middle">
                                                ...
                                                <td>'.$types->getName().'</td>
                                                <td class="text-end">
                                                    <form method="post" action="/controleurs/modify_field_person_types.php" class="d-inline-block">
                ...
                echo '   
                            ...
                            <div class="text-center mt-4">
                                <a role="button" class="btn btn-success" href="/controleurs/add_field_person_types.php">
    ...
    public function displaySelectedTypes(int $typesId): void
    {
        try {
            ...
            $statement->bindParam('id', $typesId, PDO::PARAM_INT);
            if($statement->execute()) {
                while ($country = $statement->fetchObject('FieldPersonType')) {
                    require_once (__DIR__.'/../vues/back_template.html');
                    require_once (__DIR__ . '/../vues/modify_field_person_types_form.php');
                    $_SESSION['typesId'] = $typesId;
                }
                echo '
                </main>
                </div>
    ...
    public function modifyTypes($typesId): void
    {
        try {
            require_once (__DIR__.'/../controleurs/bdd_connexion.php');
